    ...
    <section class="center">
      ...
      <article class="searchBox">
        <input
          ...
          v-model="inputVal"
          class="srchFld"
          placeholder="兄die，换一个关键词试试？"
          required
        />
        <button class="srchBtn" @click="SearchWord">Search</button>
      </article>
      <article>
        <h3>我建议您</h3>
        <ul>
          ...
          <li>
            <a target="_blank" :href="`https://www.baidu.com/s?wd=${searchTit}`"
              >百度一下</a
            >
          </li>
          <li>
...
<script>
import { searchArticle, searchCount } from "@/network/article";
export default {
  props: {
    searchTit: {
      type: String,
