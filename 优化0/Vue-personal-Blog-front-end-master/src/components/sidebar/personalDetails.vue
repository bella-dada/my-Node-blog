  ...
  <div class="personalDetails" id="introduction">
     <!-- 个人简介 -->
             <div class="block">
              <h2>刘青霞·简介</h2>
              <div>
                <p><i class="iconfont My-new-iconzhiye"></i>职业：大四学生、前端学习者</p>
                <p><i class="iconfont My-new-icondingwei1"></i>现居：四川省成都市</p>
                <p><i class="iconfont My-new-iconyouxiang"></i>Email:786540437@qq.com</p>
              </div>
              <div>
                <ul class="buttonBox">
                  <li class="item">
                   ...
                   <li class="item">
                    <a href="javascript:;" title="个人邮箱：786540437@qq.com" class="item-e-mail"></a>
                  </li>
                  <li class="item">
                    <a href="https://gitee.com/liu-qingxia" title="gitee主页" target="_blank" class="item-git"></a>
                  </li>
                  <li class="item">
