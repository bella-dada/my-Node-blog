...
<div>
  ...
  <header>
      <div class="wrapper">
        <el-row>
          <el-col :span="4">
            <div class="logo threed">刘青霞个人博客站</div>
          </el-col>
          ...
          <el-col :span="14">
            ...
            >
              ...
              <el-menu-item index="8"  @click="goToto">
                 <router-link to="/article" v-if="isSignIn === 1 && nickname === 'Bella'">我的博客</router-link>
              </el-menu-item>
              <el-menu-item index="9" @click="goToto">
               ...
               <el-menu-item index="10"  @click="goToto" >
                 <router-link to="/personal"  v-if="isSignIn === 1 "  class="login username">{{UserInfo.nickname === 'Bella' ? '尊敬的管理员：' + UserInfo.nickname : '尊敬的游客：'+ UserInfo.nickname}},欢迎您</router-link>
              </el-menu-item>
            </el-menu>
          </el-col>
          <el-col :span="6">
      ...
      <el-menu
          ...
          <el-submenu index="1">
            <template slot="title">
              ...
              <span class="logotit">刘青霞个人博客站</span>
