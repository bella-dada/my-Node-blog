     ...
     <div class="block aboutMe">
       <div class="avatar">
         <img src="～@/assets/img/avatar.jpg" alt="">
            ...
            <p><span class="threed threeds">刘青霞</span></p>
            <p><span class="threed threeds">女、99后</span></p>
            <p><span class="threed threeds">大四学生、现居成都</span></p>
            ...
            <p><span class="threed threeds">联系方式：786540437@qq.com</span></p>
            <div class="bottom">
              本博客目前还在完善中，后续会上传源码上传到gitee。本博客前端采用vue+element-ui+axios、MVVM架构模式，后端采用nodejs+express+mysql。如果有不清楚的欢迎来信。
            </div>
     </div>
    </div>
  </div>
