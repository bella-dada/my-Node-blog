  ...
  <div class="LoginBox" v-if="status == 1">
    <div class="LoginBox-Box"> 
      ...
      <el-form-item prop="name">
        <span class="passwordStyle">账号:</span><el-input placeholder="请输入账号" v-model="form.name"></el-input>
      </el-form-item>
       <el-form-item prop="password">
        <span class="passwordStyle">密码:</span><el-input placeholder="请输入密码" type="password" v-model="form.password" @keyup.enter.native="onSubmit"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  <div class="register"  v-else>
    <div class="registerBox">
      ...
      <el-form-item prop="regname">
        <span class="passwordStyle">请输入用户名:</span><el-input v-model="regform.regname"  placeholder="请输入用户名" ></el-input>
      </el-form-item>
      <el-form-item prop="nickname">
       <span class="passwordStyle">请输入昵称:</span> <el-input v-model="regform.nickname" placeholder="请输入昵称"></el-input>
      </el-form-item>
      <el-form-item  prop="pass">
        <span class="passwordStyle">请输入密码:</span><el-input type="password" placeholder="请输入密码" v-model="regform.pass" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item  prop="checkPass">
        <span class="passwordStyle">请再次输入密码:</span><el-input type="password" placeholder="请再次输入密码" v-model="regform.checkPass" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button class="login" type="primary" @click="register">注册</el-button>
      </el-form-item>
      <el-form-item>
        <span>注册完成？去<span class="sign" @click="Gotologin">登录</span></span>
        <span>随便看看？去<span class="sign" @click="Gohome">主页</span></span>
      </el-form-item>
    </el-form>
    </div>
